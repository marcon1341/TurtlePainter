 ...
 * Usage example:
 * <pre>
 * logo.World basic = new logo.World();
 * logo.World fancy = new logo.World(640, 480, Color.YELLOW);
 *
 * logo.Turtle t1 = new logo.Turtle(basic);
 * logo.Turtle t2 = new logo.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new logo.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    /**
     * Should only called by the logo.Turtle class constructor
     */
    ...
    /**
     * Should only called by logo.Turtle class methods
     */
    ...
    /**
     * To be used by logo.Turtle class only
